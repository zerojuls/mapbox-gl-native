...
- (void)testAddPackForGeometry {
    ...
    XCTAssertNil(error);
    MGLGeometryOfflineRegion *region = [[MGLGeometryOfflineRegion alloc] initWithStyleURL:styleURL geometry:geometry fromZoomLevel:zoomLevel toZoomLevel:zoomLevel];
