...
/**
 ...
 This is the designated initializer for `MGLGeometryOfflineRegion`.
 ...
 @param styleURL URL of the map style for which to download resources. The URL
    ...
    of the style.
 @param geometry The geometry for the geographic region to be covered by
 ...
 @param maximumZoomLevel The maximum zoom level to be covered by the downloaded
    ...
    level.
 */
- (instancetype)initWithStyleURL:(nullable NSURL *)styleURL geometry:(MGLShape *)geometry fromZoomLevel:(double)minimumZoomLevel toZoomLevel:(double)maximumZoomLevel NS_DESIGNATED_INITIALIZER;
